...
_BADGES = {"test_quiz":"🎯","listening":"🎧","reading":"📚","speaking":"🗣",
           "vocabulary":"📖","writing":"✍️","homework":"📝","visuals":"🖼"}
...
async def show_lessons(update, context):
    ...
    name = (dict(student).get("full_name") or u.first_name or "Student") if student else u.first_name
