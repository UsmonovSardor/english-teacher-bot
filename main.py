...
async def callback_route(update, context):
    ...
    try:
        ...
        if data == "student":
            ...
            return await show_category(update, context, int(p[0]), p[1])
        ...
        # ADMIN
            ...
            return await show_submissions(update, context)
            ...
            return await show_cat(update, context, int(lid), cat)
            ...
            return await add_content_start(update, context, int(lid), cat)
            ...
            return await clear_cat(update, context, int(lid), cat)
            ...
            try:
                await query.answer("⚠️ This button is not connected yet.", show_alert=True)
            except Exception:
                pass
        ...
        try:
            await query.answer("⚠️ Error. Please try again.", show_alert=True)
        except Exception:
            pass
